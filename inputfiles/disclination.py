...
parser.add_argument("--snapshots", type=int, required=True, help="Number of snapshots") # quantos estados intermediários serão salvos
parser.add_argument("--run_steps", type=int, required=True, help="Number of run steps") # quantos passos de Monte Carlo são feitos por temperatura
parser.add_argument("--N", type=int, required=True, help="Pentagon Number size") # define o tamanho da malha, acessando os arquivos como vertices_N5.inp
